# Step_08e_TabPFN_SHAP_2000 - Kaggle version (generated by build_kaggle_steps.py; step code below is the local step unchanged)
...
# Result: /kaggle/working/Step_08e_TabPFN_SHAP_2000.zip (downloads automatically) -> import on the Mac with import_kaggle_run.py.

import base64, glob, io, os, shutil, subprocess, sys, time, types
from pathlib import Path

STEP = "Step_08e_TabPFN_SHAP_2000"
NEEDS = ['shap', 'tabpfn']   # extra pip packages for this step
...
# ======================= step code (unchanged from backend/steps/Step_08e_TabPFN_SHAP_2000.py) =======================
