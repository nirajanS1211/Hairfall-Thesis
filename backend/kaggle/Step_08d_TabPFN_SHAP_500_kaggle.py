# Step_08d_TabPFN_SHAP_500 - Kaggle version (generated by build_kaggle_steps.py; step code below is the local step unchanged)
...
# Result: /kaggle/working/Step_08d_TabPFN_SHAP_500.zip (downloads automatically) -> import on the Mac with import_kaggle_run.py.
