# Step_04_TrainTestSplit - Kaggle version (generated by build_kaggle_steps.py; step code below is the local step unchanged)
# Paste into ONE Kaggle notebook cell and Run.
# Settings: Accelerator = None (CPU is fine), Internet = Off is fine.
# Needs as a Kaggle dataset (Add Input): Step_03_CleanEncode.
# Result: /kaggle/working/Step_04_TrainTestSplit.zip (downloads automatically) -> import on the Mac with import_kaggle_run.py.
...
# ======================= step code (unchanged from backend/steps/Step_04_TrainTestSplit.py) =======================
