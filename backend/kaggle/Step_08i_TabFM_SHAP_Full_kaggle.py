# Step_08i_TabFM_SHAP_Full - Kaggle version (generated by build_kaggle_steps.py; step code below is the local step unchanged)
...
# Result: /kaggle/working/Step_08i_TabFM_SHAP_Full.zip (downloads automatically) -> import on the Mac with import_kaggle_run.py.

import base64, glob, io, os, shutil, subprocess, sys, time, types
from pathlib import Path

STEP = "Step_08i_TabFM_SHAP_Full"
NEEDS = ['shap', 'tabfm[pytorch]==1.0.1']   # extra pip packages for this step
...
# ======================= step code (unchanged from backend/steps/Step_08i_TabFM_SHAP_Full.py) =======================
