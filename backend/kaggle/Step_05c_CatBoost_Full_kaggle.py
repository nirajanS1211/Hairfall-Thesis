# Step_05c_CatBoost_Full - Kaggle version (generated by build_kaggle_steps.py; step code below is the local step unchanged)
...
# Result: /kaggle/working/Step_05c_CatBoost_Full.zip (downloads automatically) -> import on the Mac with import_kaggle_run.py.

import base64, glob, io, os, shutil, subprocess, sys, time, types
from pathlib import Path

STEP = "Step_05c_CatBoost_Full"
NEEDS = ['catboost']   # extra pip packages for this step
...
# ======================= step code (unchanged from backend/steps/Step_05c_CatBoost_Full.py) =======================
