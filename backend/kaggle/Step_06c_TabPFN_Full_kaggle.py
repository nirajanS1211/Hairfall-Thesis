# Step_06c_TabPFN_Full - Kaggle version (generated by build_kaggle_steps.py; step code below is the local step unchanged)
...
# Result: /kaggle/working/Step_06c_TabPFN_Full.zip (downloads automatically) -> import on the Mac with import_kaggle_run.py.
...
# ======================= step code (unchanged from backend/steps/Step_06c_TabPFN_Full.py) =======================
# Step 6c - TabPFN · Full
