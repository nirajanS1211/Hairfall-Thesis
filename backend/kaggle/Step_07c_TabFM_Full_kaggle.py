# Step_07c_TabFM_Full - Kaggle version (generated by build_kaggle_steps.py; step code below is the local step unchanged)
...
# Result: /kaggle/working/Step_07c_TabFM_Full.zip (downloads automatically) -> import on the Mac with import_kaggle_run.py.
