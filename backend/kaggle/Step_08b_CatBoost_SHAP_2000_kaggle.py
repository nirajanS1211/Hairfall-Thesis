# Step_08b_CatBoost_SHAP_2000 - Kaggle version (generated by build_kaggle_steps.py; step code below is the local step unchanged)
# Paste into ONE Kaggle notebook cell and Run.
# Settings: Accelerator = None (CPU is fine), Internet = On.
# Needs as a Kaggle dataset (Add Input): Step_05b_CatBoost_2000.
# Result: /kaggle/working/Step_08b_CatBoost_SHAP_2000.zip (downloads automatically) -> import on the Mac with import_kaggle_run.py.
