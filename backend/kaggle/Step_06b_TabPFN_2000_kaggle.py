# Step_06b_TabPFN_2000 - Kaggle version (generated by build_kaggle_steps.py; step code below is the local step unchanged)
...
# Result: /kaggle/working/Step_06b_TabPFN_2000.zip (downloads automatically) -> import on the Mac with import_kaggle_run.py.
...
# ======================= step code (unchanged from backend/steps/Step_06b_TabPFN_2000.py) =======================
# Step 6b - TabPFN · 2000
