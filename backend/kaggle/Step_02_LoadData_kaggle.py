# Step_02_LoadData - Kaggle version (generated by build_kaggle_steps.py; step code below is the local step unchanged)
...
# Result: /kaggle/working/Step_02_LoadData.zip (downloads automatically) -> import on the Mac with import_kaggle_run.py.
