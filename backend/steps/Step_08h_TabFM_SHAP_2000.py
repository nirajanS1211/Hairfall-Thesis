# Step 8h - TabFM SHAP · 2000
# TabFM SHAP (KernelExplainer, model-agnostic) | context = 2000
import time
...
SIZE = "2000"
N_EXPLAIN = 20   # test rows to explain  (cost ~ N_EXPLAIN x NSAMPLES x BACKGROUND predictions)
NSAMPLES = 100
BACKGROUND = 5    # k-means summary of the context used as SHAP background
